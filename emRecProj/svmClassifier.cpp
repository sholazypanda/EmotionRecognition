...
int SvmClassifier::svmTrain() {
    ...
    const char* happyTrainfile="/Users/Heman/Downloads/77traindata01.csv";
    svmTrain(happyTrainfile, 1);
    
    const char* surprisedTrainfile="/Users/Heman/Downloads/77SurpriseTraindata.csv";
    svmTrain(surprisedTrainfile, 2);
    
    const char* angerTrainingFile="/Users/Heman/Downloads/77AngerTraindata.csv";
    svmTrain(angerTrainingFile, 3);
    
    const char* disgustTrainingFile="/Users/Heman/Downloads/77DisgustTraindata.csv";
