...
int SvmClassifier::svmTrain() {
    ...
    const char* happyTrainfile="/Users/shobhikapanda/Downloads/77traindata01.csv";
    svmTrain(happyTrainfile, 1);
    
    const char* surprisedTrainfile="/Users/shobhikapanda/Downloads/SurpriseTraindata.csv";
    svmTrain(surprisedTrainfile, 2);
    
    //const char* angerTrainingFile="/Users/shobhikapanda/Downloads/77AngerTraindata.csv";
   // svmTrain(angerTrainingFile, 3);
    
   // const char* disgustTrainingFile="/Users/shobhikapanda/Downloads/77DisgustTraindata.csv";
